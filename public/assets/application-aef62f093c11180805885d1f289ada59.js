...
(function() {
  ...
  init = function() {
    ...
    $('.combobox').combobox();
    $(".friends").on("cocoon:after-insert", function(e, insertedItem) {
      return insertedItem.find('.combobox').combobox();
    });
    $("#provisional_budget").on("cocoon:after-insert", function(e, insertedItem) {
      return insertedItem.find('.combobox').combobox();
    });
    return $("#anticipated_funding").on("cocoon:after-insert", function(e, insertedItem) {
      return insertedItem.find('.combobox').combobox();
    });
  };
